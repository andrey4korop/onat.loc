...
<head>
    ...
    <title>Електронний університет</title>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal"  method="POST" action="{{ url('/register') }}">
                ...
                <div class="form-group has-feedback">
                    <label for="name" class="control-label col-xs-4">ПІП:</label>
                ...
                <div class="form-group">
                    <label for="name"  class="control-label col-xs-4">Номер телефону:</label>
                ...
                <div class="form-group">
                    <label for="password-confirm" class="control-label col-xs-4">Повторіть пароль</label>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#registration" style="margin-top: 8px">Реєстрація</button>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Електронний університет</h2>
        </div>
        <div class="col-md-4">
            <div class="media">
                <div class="pull-left">
