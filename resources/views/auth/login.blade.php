...
<i class="fa fa-exclamation fa-stack-1x fa-inverse"></i>
                ...
                <div class="media-body">
                    ...
                    <p>Система гарантує якісний і точний розрахунок данних.</p>
                </div>
            </div>
            <div class="media">
                <div class="pull-left">
...
<i class="fa fa-laptop fa-stack-1x fa-inverse"></i>
                ...
                <div class="media-body">
                    ...
                    <p>Не потрібно бути досвідченним користувачем, щоб користуватися системою.</p>
                </div>
            </div>
            <div class="media">
                <div class="pull-left">
...
<i class="fa fa-save fa-stack-1x fa-inverse"></i>
                ...
                <div class="media-body">
                    ...
                    <p>Система дозволяє експортувати данні в Excel, PDF та електронну пошту.</p>
                </div>
            </div>
...
<i class="fa fa-lock fa-stack-1x fa-inverse"></i>
                ...
                <div class="media-body">
                    ...
                    <p>Гарантії захисту інформації, що містяться в данній системі.</p>
                </div>
            </div>
            <div class="media">
                <div class="pull-left">
...
<i class="fa fa-print fa-stack-1x fa-inverse"></i>
                ...
                <div class="media-body">
                    ...
                    <p>Система дозволяє в режимі online друкування документів.</p>
                </div>
            </div>
